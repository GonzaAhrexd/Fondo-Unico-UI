...
import { AdministrarUsuariosComponent as AdministrarUsuarios } from '../../components/Usuarios/administrar-usuarios/administrar-usuarios.component';
...
@Component({
  ...
  imports: [NavBarComponent, CardActionsComponent, AdministrarUsuarios, NuevoUsuarioComponent],
...
export class AdministrarUsuariosComponent {
  ...
  ngOnInit(){
    ...
    if (!isAuth) { // Si no está autenticado, redirige al login
      ...
      let rol = this.userService.getUser().rol; // Obtiene el rol del usuario
